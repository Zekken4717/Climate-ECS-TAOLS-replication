Updated: 2026-06-09
Directory: Empirical_application_matlab\

==========================================================================
RECOMMENDED RUN ORDER
==========================================================================

  1. Plot_Data_Unit_Root_Normality_Tests.m   (pre-estimation diagnostics)
  2. Empirical_Analysis_Climate_trendType_1_in_mc.m   (run 3 times: model I, II, III)
  3. extract_ranges_and_combine.m   (combined figures + numerical ranges)
...
Plot_Data_Unit_Root_Normality_Tests.m
  ...
  Figures produced:
    ...
    Figure 2 -- Histograms of first differences with fitted normal density;
                JB statistic and p-value annotated on each panel
    Figure 3 -- Normal Q-Q plots of first differences
  ...
  Outputs saved to Results_Diagnostics\ :
    ...
    fd_histograms.fig/.eps/.png             -- histograms (Figure 2)
    fd_qqplots.fig/.eps/.png                -- Q-Q plots (Figure 3)

  Also copies rf_temperature_combined.png/.eps to ..\Paper_June_2026\ for LaTeX.

  Requires: Econometrics Toolbox + Statistics & Machine Learning Toolbox.
...
Empirical_Analysis_Climate_trendType_1_in_mc.m
  ...
  Figures produced:
    ...
    Figure 5    -- TAOLS estimates of trend coefficient (cointegration model,
                   ...
                   [screen only -- not saved to disk]
    Figure 1000 -- Predicted OHC (TAOLS) vs observed OHC series (1940-2014).
...
extract_ranges_and_combine.m
  ...
  Loads the .mat files produced by Script 2 for all three models and:
  ...
  (i.e., all six .mat files in Results_Model_*\ must exist).
...
Each run of Script 2 produces the following files inside that subfolder:
  ...
  Model_<model>_cointTrendType_<N>.out
      Diary of printed summary statistics (lambda, SE, ECS, phi).

  <prefix>_trendType_<M>_mc_lambda_ECS.fig / .eps / .mat
      TAOLS estimates of lambda and ECS from the multicointegration model,
      with 95% CI bands. mat file contains: Ks, TA_OLS_mc_lambda, TA_OLS_mc_ECS.

  <prefix>_trendType_<M>_mc_phi_percent.fig / .eps / .mat
      TAOLS estimates of phi and % heat content toward surface warming,
      with 95% CI bands. mat file contains: Ks, TA_OLS_mc_phi, TA_OLS_mc_percent.

  <prefix>_trendType_<M>_mc_OHC_comparison.fig / .eps
  ...
  <prefix>_trendType_<N>_coint_lambda_ECS.fig / .eps / .mat
      TAOLS estimates of lambda and ECS from the regular cointegration model,
      with 95% CI bands. mat file contains: Ks, TA_OLS_lambda, TA_OLS_ECS.
...
Results_Model_I_cointTrendType_0\
  Full_RF_BerkeleyT_trendType_1_mc_lambda_ECS.fig/.eps/.mat
  Full_RF_BerkeleyT_trendType_1_mc_phi_percent.fig/.eps/.mat
  Full_RF_BerkeleyT_trendType_1_mc_OHC_comparison.fig/.eps
  Full_RF_BerkeleyT_trendType_0_coint_lambda_ECS.fig/.eps/.mat
  Model_I_cointTrendType_0.out

Results_Model_II_cointTrendType_0\
  Partial_RF_BerkeleyT_trendType_1_mc_lambda_ECS.fig/.eps/.mat
  Partial_RF_BerkeleyT_trendType_1_mc_phi_percent.fig/.eps/.mat
  Partial_RF_BerkeleyT_trendType_1_mc_OHC_comparison.fig/.eps
  Partial_RF_BerkeleyT_trendType_0_coint_lambda_ECS.fig/.eps/.mat
  Model_II_cointTrendType_0.out

Results_Model_III_cointTrendType_0\
  Partial_RF_HADCRUT_trendType_1_mc_lambda_ECS.fig/.eps/.mat
  Partial_RF_HADCRUT_trendType_1_mc_phi_percent.fig/.eps/.mat
  Partial_RF_HADCRUT_trendType_1_mc_OHC_comparison.fig/.eps
  Partial_RF_HADCRUT_trendType_0_coint_lambda_ECS.fig/.eps/.mat
  Model_III_cointTrendType_0.out

Results_Diagnostics\
  unit_root_normality_tests.out
  rf_temperature_combined.fig/.eps/.png
  fd_histograms.fig/.eps/.png
  fd_qqplots.fig/.eps/.png
